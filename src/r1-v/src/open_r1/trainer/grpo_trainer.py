...
class Qwen2VLGRPOTrainer(Trainer):
    ...
    def compute_loss(self, model, inputs, return_outputs=False, num_items_in_batch=None):
        ...
        if inputs[0]['data_type'] == 'image':
            input_copy[0]['content'][0]['image'] = "/mnt/xmap_nas_alg/yzl/Auto_Drive/AFile/datasets/" + inputs[0]['path']
        elif inputs[0]['data_type'] == 'video':
            input_copy[0]['content'][0]['video'] = "/mnt/xmap_nas_alg/yzl/Auto_Drive/AFile/datasets/" + inputs[0]['path']
        ...
        try:
            ...
            if inputs[0]['data_type'] == 'image':
                input_copy[0]['content'][0]['image'] = "/mnt/xmap_nas_alg/yzl/Auto_Drive/AFile/datasets/" + 'Math/Multimath-300k/17ff4c7d14c388134de02381b1fc2824.png'
            elif inputs[0]['data_type'] == 'video':
                input_copy[0]['content'][0]['video'] = "/mnt/xmap_nas_alg/yzl/Auto_Drive/AFile/datasets/" + 'LLaVA-Video-178K/liwei_youtube_videos/videos/youtube_video_2024/ytb_7nRmsEw7nsE.mp4'
